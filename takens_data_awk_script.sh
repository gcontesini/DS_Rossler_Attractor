<<<<<<< HEAD
awk -F "\t" '$1 {print $2}' ts_rossler_oscilator.dat > takens_x_no_lag.dat
awk -F "\t" '$1>0.30 {print $2}' ts_rossler_oscilator.dat > takens_x_first_lag.dat
awk -F "\t" '$1>0.60 {print $2}' ts_rossler_oscilator.dat > takens_x_second_lag.dat

awk -F "\t" '$1 {print $3}' ts_rossler_oscilator.dat > takens_y_no_lag.dat
awk -F "\t" '$1>0.30 {print $3}' ts_rossler_oscilator.dat > takens_y_first_lag.dat
awk -F "\t" '$1>0.60 {print $3}' ts_rossler_oscilator.dat > takens_y_second_lag.dat

awk -F "\t" '$1 {print $4}' ts_rossler_oscilator.dat > takens_z_no_lag.dat
awk -F "\t" '$1>0.30 {print $4}' ts_rossler_oscilator.dat > takens_z_first_lag.dat
awk -F "\t" '$1>0.60 {print $4}' ts_rossler_oscilator.dat > takens_z_second_lag.dat
...
>>>>>>> 221e463040185b7d8582ef844075a889618ac73f
